...
// Classe para representar um ator no sistema de comércio eletrônico
class Ator {
    String nome;
...
// Classe para representar um caso de uso no sistema de comércio eletrônico
class CasoDeUso {
    String nome;
    List<String> acoes;

    public CasoDeUso(String nome, List<String> acoes) {
        this.nome = nome;
        this.acoes = acoes;
    }
}
